...
export function activate(context: vscode.ExtensionContext) {
	...
	if (vscode.window.activeTextEditor) {
		let diag=validateTransforms(vscode.window.activeTextEditor.document, collection);
...
function validateTransforms(document: vscode.TextDocument, collection: vscode.DiagnosticCollection): Array {
	let diag = [];
	if (document) {
...
function difference(setA: Set, setB: Set) {
